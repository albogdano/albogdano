...
**Heavily business-focused** and aiming to provide maximum value with minimum technical debt and complexity.<br>
**Comfortable wearing multiple hats at once** - developer, business owner and talking to customers for tech support and sales.<br>
**Experienced in AI-assisted software development** workflows using Claude Code, Codex and OpenCode (multiple LLMs).

Technical expertise in building distributed systems from the ground up with Java (both SE and EE), including a cloud-based
service running in production on AWS and integrated with the Braintree payment gateway. Detailed understanding of
the web stack - frontend development with vanilla JavaScript, Node.js, HTML and CSS; backend development
with Java, Node.js. In-depth knowledge of SQL and NoSQL databases, including MySQL, MongoDB,
Cassandra and DynamoDB. Experience with developing and deploying Spring applications production.
Ability to quickly pick up any new language or platform and get going without supervision.

## Hobbies and interests

- Cycling - the struggle of the climb and the rush of the descent.
- 3D printing and building custom small form factor PCs
- I have a huge Casio watch collection
